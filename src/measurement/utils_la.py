# this module contains useful linear algebra routines over \mathbb{R} and \mathbb{Z}_2
# for now it has no use in the context of the quantum subspace expansion project
# but it is called by utils_fc for some of its functions. Thus it is included here
