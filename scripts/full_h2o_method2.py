...
output_filename = f'results/h2o_method2_{bond_length}'
...
#import CSF from dump files

from ..seniority.circuits_csf import get_Uext_csfs_from_dump

CSF_states = get_Uext_csfs_from_dump(input_file=filename, verify_states=False, verbose=False)
